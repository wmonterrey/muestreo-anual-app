...
public final class FileUtils {
    ...
    // Storage paths
    public static final String COHORTE_ROOT = Environment.getExternalStorageDirectory() + "/ics/muestreoanual/";
    public static final String DATABASE_PATH = COHORTE_ROOT + "databases/";
