 ...
 * </p>
 */
public abstract class CohorteSQLiteOpenHelper {
    private static final String t = CohorteSQLiteOpenHelper.class.getSimpleName();
     ...
     */
    public CohorteSQLiteOpenHelper(String path, String name, CursorFactory factory, int version) {
        if (version < 1)
