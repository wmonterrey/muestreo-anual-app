...
public class LoginActivity extends Activity {
	...
	public class UserLoginTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			try {
				...
				ResponseEntity<User> userFromServer = restTemplate.exchange(urlRequest, HttpMethod.GET, new HttpEntity<Object>(requestHeaders), User.class, mUser);
				...
				ca.open();
				if(!ca.existeUsuario(mUser)){
					ca.crearUsuarioFromLogin(userFromServer.getBody(),mPassword);
				}
				else {
					ca.actualizarUsuarioFromLogin(userFromServer.getBody(),mPassword);
				}
				ca.borrarTodosRoles(mUser);
	...
	private void ingresarLocal() {
		...
		CohorteAdapter ca = new CohorteAdapter();
		ca.open();
		String pass = ca.buscarPassword(mUser);
		ca.close();
